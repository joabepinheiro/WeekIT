{!! Form::open(['method' => 'POST', 'action' => $model::$controller.'@store', 'class' => 'm-form m-form--fit m-form--label-align-right m-form--state block_form_submit']) !!}

<div class="m-form__section m-form__section--first">

    @foreach( $model::fieldsFormCreate()['fields'] as $index =>  $row)
        <?php
        $count = count($row);
