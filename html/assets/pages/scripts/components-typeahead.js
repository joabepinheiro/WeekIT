var ComponentsTypeahead = function () {
    ...
    var handleTwitterTypeahead = function() {
        ...
        var instituicoes = new Bloodhound({
            datumTokenizer: function(d) { return Bloodhound.tokenizers.whitespace(d.num); },
            queryTokenizer: Bloodhound.tokenizers.whitespace,
            local: [
                { num: 'Instituto Federal de Educação, Ciência e Tecnologia da Bahia (IFBA)' },
                { num: 'Faculdade Independente do Nordeste (FAINOR)' },
                { num: 'Faculdade de Tecnologia e Ciências (FTC)' },
                { num: 'Universidade Estadual do Sudoeste da Bahia (UESB)' },
                { num: 'Universidade Federal da Bahia (UFBA)' }
            ]
        });
        ...
        var cursos = new Bloodhound({
            ...
            queryTokenizer: Bloodhound.tokenizers.whitespace,
            local: [
                { num: 'TÉCNICO EM ELETROMECÂNICA' },
                { num: 'TÉCNICO EM ELETRÔNICA' },
                { num: 'TÉCNICO EM INFORMÁTICA' },
                { num: 'TÉCNICO EM MEIO AMBIENTE' },
                { num: 'Sistemas de Informação' }
            ]
        });
        ...
        $('#instituicao').typeahead(null, {
            displayKey: 'num',
            hint: (App.isRTL() ? false : true),
            source: instituicoes.ttAdapter()
        });

        $('#curso').typeahead(null, {
            displayKey: 'num',
            hint: (App.isRTL() ? false : true),
            source: cursos.ttAdapter()
        });
