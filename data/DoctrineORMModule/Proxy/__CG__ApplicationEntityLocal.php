 ...
 */
class Local extends \Application\Entity\Local implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Application\\Entity\\Local' . "\0" . 'id', '' . "\0" . 'Application\\Entity\\Local' . "\0" . 'descricao', '' . "\0" . 'Application\\Entity\\Local' . "\0" . 'cadastradoEm'];
        }
